...
Doctor is also invoked as **Phase 5 of the install plan** generated by `/llake-lady`. That means the same verification surface runs whether the wizard or a resumed session executes the plan.
...
- Install plan template (Phase 5 of which invokes this skill): `templates/plan.md.tmpl`.
